			...
			<?php if ( $display_submitted ) : ?>
				<div class="submitted node-submitted" role="contentinfo">
					...
					<?php if ( $submitted ) : // node author ?>
						<span class="node-author"><?php print t( "by " ) . $submitted; ?></span>
					<?php endif;

					if ( $submitted_pubdate ) : // publish date ?>
						<span class="node-time" >
							<time datetime="<?php print $submitted_pubdate; ?>"><?php print t( " on " ) . $submitted_date; ?></time>
						</span>
					<?php endif; ?>

					<?php // number of comments ?>
					<span class="node-comments">
						<a href="<?php echo $node_url;?>#comments"><?php print t( "Comments " ) . $comment_count ; ?> </a>
					</span>
				</div>
			<?php endif; ?>
		</header>
